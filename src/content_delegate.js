...
ContentDelegate.prototype.onDocumentViewSubmit = function (event) {
  ...
  if (!PACER.isAppellateCourt(this.court)) {
    ...
    let docket_number_matches = docket_number_regex.exec(receipt_search_criteria);

    document_number = (document_number_matches) ? document_number_matches[1] : '';
    attachment_number = (attachment_number_matches) ? attachment_number_matches[1] : '';
    docket_number = (docket_number_matches) ? docket_number_matches[1] : '';
  }
